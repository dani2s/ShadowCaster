...
class BlastAtyipical():
    ...
    def __init__(self,listProteomes, alienCds, protFolder, blastp26= 'blastp', blast26db = 'formatdb'):
    ...
    def performBlastp(self):
        ...
        os.system('generate_R_input.pl %s %s %s %s' %(self.alienFaa, blast, self.blastProtein, self.proteomes)) 
